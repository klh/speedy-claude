...
- **PASS** — no findings, or only WARNs (doc drift). Then mint the signed approval: `approve-skill <source-ref>` — the install gate verifies and consumes it (single-use, 24h).
