...
> Install: `npx skills add klh/skills --skill klh-code-simplifier`
...
- **klh-find-bugs** — simplify code first, then audit for bugs for cleaner review output
- **klh-testing-patterns** — simplified code is easier to test and mock