...
> Install: `npx skills add klh/skills --skill klh-systematic-debugging`
...
- **klh-testing-patterns**: Create test that reproduces the bug before fixing
